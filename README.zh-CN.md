...
### 6. 闭环的质量保证 (Automated Verification via MCP)
...
└── rules/                          # 核心规则库
    ├── 01-omnidev-workflow.mdc     # 核心工作流（含复杂度评估、需求变更、历史项目学习）
